...
(function() {
    ...
    function addBookmarkClicked() {
        ...
        var url = $("#txtUrl").val();
        var currentUser = userSession.getCurrentUser();
        ajaxRequester.createBookmarks(title, url, currentUser.objectId,
            showBookmarksView, addBookmarksError );
    }

    function addBookmarksError(error) {
        showErrorMessage('Bookmarks creation failed');
    }
    ...
    function deleteBookmark(sessionToken, bookmark) {
        ajaxRequester.deleteBookmarks(sessionToken , bookmark.objectId, showBookmarksView, deleteBookmarkError);
    }

    function deleteBookmarkError(error) {
        showErrorMessage('Bookmark delete failed');
    }
